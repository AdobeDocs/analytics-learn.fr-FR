...
**Exemples :** dans [CE](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/spa-editor/spa-editor-framework-feature-video-use.html?lang=fr) document d’aide, il existe des liens vers des exemples de sites SPA qui ont implémenté [!DNL Analytics] (et d’autres solutions Experience Cloud), ainsi que des documents décrivant ce qui a été implémenté. Dans ces exemples de SPA, les événements personnalisés suivants ont été utilisés :
