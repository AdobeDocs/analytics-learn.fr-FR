...
description: Divisez et segmentez vos données avec la segmentation dans Adobe Analytics. Cette vidéo vous guide tout au long du processus d’utilisation du créateur de segments et vous donne un aperçu de base de celui-ci.
