...
+ Introduction à Analytics {#intro-to-analytics}
   + Que peut faire Adobe Analytics pour moi ? {#what-can-aa-do-for-me}
      ...
      + [Plus que des données. Cʼest de lʼintelligence client](intro-to-analytics/what-can-aa-do-for-me/adobe-analytics-customer-intelligence.md)
      + [Adobe Sensei et Adobe Analytics](intro-to-analytics/what-can-aa-do-for-me/adobe-sensei-and-adobe-analytics.md)
      + [Cas dʼutilisation client - ServiceNow](intro-to-analytics/what-can-aa-do-for-me/servicenow-gets-the-right-insights-to-connect-with-prospects.md)
      + [Cas dʼutilisation client - Accent Group](intro-to-analytics/what-can-aa-do-for-me/accent-group-invests-in-customer-experience-to-drive-sales.md)
      + [Cas dʼutilisation client - Home Depot](intro-to-analytics/what-can-aa-do-for-me/the-home-depot-innovates-with-customer-experience-management.md)
   ...
   + Concepts de base d’Analytics {#analytics-basics}
      + [Bouton Essayer dans Workspace dans Reports and Analytics](intro-to-analytics/analytics-basics/try-in-workspace-button.md)
      ...
      + [Présentation de lʼinterface utilisateur dʼAnalytics](intro-to-analytics/analytics-basics/intro-to-the-analytics-ui.md)
      + [Compréhension et création de suites de rapports](intro-to-analytics/analytics-basics/understanding-and-creating-report-suites.md)
   ...
   + Accès à l’aide {#getting-help}
      ...
      + [Envoi du ticket dʼassistance en ligne](intro-to-analytics/getting-help/in-product-support-ticket-submission.md)
      + [Aide pour Adobe Analytics](intro-to-analytics/getting-help/getting-help.md)
+ Analysis Workspace {#analysis-workspace}
   + Principes de base dʼAnalysis Workspace {#analysis-workspace-basics}
      + [Introduction à Analysis Workspace](analysis-workspace/analysis-workspace-basics/analysis-workspace-introduction.md)
      + [Aperçu d’Analysis Workspace](analysis-workspace/analysis-workspace-basics/analysis-workspace-overview.md)
      + [Création de nouveaux projets dans Analysis Workspace](analysis-workspace/analysis-workspace-basics/creating-new-analysis-workspace-projects.md)
      ...
      + [Utilisation de modèles personnalisés pour aider les nouveaux utilisateurs dʼAnalysis Workspace](analysis-workspace/analysis-workspace-basics/using-custom-templates-to-enable-novice-users.md)
      + [Compréhension des données présentes dans votre projet Analysis Workspace](analysis-workspace/analysis-workspace-basics/understanding-how-data-gets-into-your-analysis-workspace-project.md)
      ...
      + [Sélection dʼune suite de rapports dans Analysis Workspace](analysis-workspace/analysis-workspace-basics/selecting-a-report-suite-in-analysis-workspace.md)
   ...
   + Navigation dans les projets Workspace {#navigating-workspace-projects}
      ...
      + [Création dʼune table des matières](analysis-workspace/navigating-workspace-projects/create-a-toc-in-analysis-workspace.md)
      ...
      + [Annulation des actions dans Analysis Workspace](analysis-workspace/navigating-workspace-projects/undoing-actions-in-analysis-workspace.md)
      + [Densité dʼaffichage dans Analysis Workspace](analysis-workspace/navigating-workspace-projects/view-density-in-analysis-workspace.md)
      + [Améliorations de lʼétat zéro](analysis-workspace/navigating-workspace-projects/zero-state-improvements.md)
   ...
   + Utilisation des panneaux {#using-panels}
      ...
      + [Utilisation du panneau Attribution IQ](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/attribution-iq/using-the-attribution-iq-panel.html)
   ...
   + Création de tableaux à structure libre {#building-freeform-tables}
      ...
      + [Utilisation dʼAttribution IQ dans les tableaux à structure libre](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/attribution-iq/using-attribution-iq-in-freeform-tables.html)
      ...
      + [Menu contextuel dans Analysis Workspace (suite)](analysis-workspace/building-freeform-tables/continued-right-click-menu-in-analysis-workspace.md)
      + [Analyse de ventes croisées dans Analysis Workspace](analysis-workspace/building-freeform-tables/cross-sell-analysis-workspace.md)
      + [Filtres des tableaux à structure libre](analysis-workspace/building-freeform-tables/freeform-table-filters.md)
      + [Dimensions de répartition du temps dans Analysis Workspace](analysis-workspace/building-freeform-tables/time-parting-dimensions-in-analysis-workspace.md)
   ...
   + Visualisations {#visualizations}
      ...
      + [Obtention de données dans des visualisations](analysis-workspace/visualizations/getting-data-into-visualizations.md)
      ...
      + [Ajout de tendances aux visualisations linéaires](analysis-workspace/visualizations/adding-trendlines-to-line-visualizations.md)
      ...
      + [Modification de lʼéchelle et de lʼaxe sur les visualisations](analysis-workspace/visualizations/changing-the-scale-axis-on-visualizations.md)
      ...
      + [Paramètres des sources de données des tableaux](analysis-workspace/visualizations/table-data-source-settings.md)
      + [Création dʼune carte thermique de répartition du temps](analysis-workspace/visualizations/build-a-time-parting-heatmap.md)
      + [Visualisation Treemap et Scatterplot](analysis-workspace/visualizations/treemap-and-scatterplot-visualizations.md)
      + [Visualisation du diagramme de Venn](analysis-workspace/visualizations/venn-diagram-visualization.md)
      + [Paramètres des sources de données des visualisations](analysis-workspace/visualizations/visualization-data-source-settings.md)
   + Application de segments {#applying-segments}
      ...
      + [Utilisation de différents modèles Attribution IQ avec des segments](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/attribution-iq/using-different-attribution-iq-models-with-segments.html)
   ...
   + Mesures {#metrics}
      + [Concepts de base de la mesure Visiteur](analysis-workspace/metrics/understanding-basic-visitor-metrics.md)
      + [Ajout de dimensions et de mesures à votre projet dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/dimensions/adding-dimensions-and-metrics-to-your-project-in-analysis-workspace.html)
      + [Présentation des événements de conversion](analysis-workspace/metrics/introduction-to-conversion-events.md)
      + [Utilisation de mesures dans une table à structure libre](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/working-with-metrics-in-a-freeform-table.html)
   ...
   + Dimensions {#dimensions}
      ...
      + [Utilisation des dimensions dans un tableau à structure libre](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/working-with-dimensions-in-a-freeform-table.html)
   ...
   + Analyse des parcours client {#analyzing-customer-journeys}
      ...
      + [Abandons multidimensionnels](analysis-workspace/analyzing-customer-journeys/multi-dimensional-fallout.md)
   ...
   + Organisation et partage de projets {#curate-and-share-projects}
      ...
      + [Exporter au format CSV à partir dʼAnalysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/from-the-ui/export-to-csv-from-analysis-workspace.html)
   ...
   + Attribution IQ {#attribution-iq}
      + [Utilisation de lʼanalyse croisée pour étudier lʼattribution marketing de base](analysis-workspace/attribution-iq/using-cross-tab-analysis-to-explore-basic-marketing-attribution-in-analysis-workspace.md)
      ...
      + [Utilisation dʼAttribution IQ dans les tableaux à structure libre](analysis-workspace/attribution-iq/using-attribution-iq-in-freeform-tables.md)
   ...
   + Analyse des cohortes {#cohort-analysis}
      ...
      + [Analyse de cohortes à partir de nʼimporte quelle dimension](analysis-workspace/cohort-analysis/cohort-analysis-using-any-dimension.md)
      + [Analyse de la latence à lʼaide des tableaux de cohortes](analysis-workspace/cohort-analysis/latency-analysis-with-cohort-tables.md)
   ...
   + Analyses vocales {#voice-analytics}
      + [Gestion et suivi des données de lʼapplication dʼassistant vocal](analysis-workspace/voice-analytics/how-to-manage-and-track-your-voice-assistant-app-data.md)
      + [Compréhension des différences entre les appareils à commande vocale](analysis-workspace/voice-analytics/understand-differences-across-voice-enabled-devices.md)
      + [Trouver des opportunités pour augmenter lʼengagement pour les applications vocales](analysis-workspace/voice-analytics/finding-opportunities-to-increase-engagement-for-voice-apps.md)
      + [Réduction du taux dʼerreur et amélioration du taux de réussite dans votre application vocale](analysis-workspace/voice-analytics/reducing-error-rates-and-improving-success-rates-in-your-voice-app.md)
      ...
      + [Compréhension du parcours vocal de lʼutilisateur](analysis-workspace/voice-analytics/understanding-the-users-voice-journey.md)
...
+ Administration {#administration}
   ...
   + Journaux {#logs}
      + [Suivi des journaux dʼutilisation pour Analysis Workspace](administration/logs/usage-log-tracking-for-analysis-workspace.md)
+ Implémentation {#implementation}
   + Concepts de base de la mise en œuvre {#implementation-basics}
      ...
      + [Création dʼun document dʼexigences de lʼentreprise](implementation/implementation-basics/creating-a-business-requirements-document.md)
      + [Création et mise à jour dʼun document de conception de solution](implementation/implementation-basics/creating-and-maintaining-an-sdr.md)
      + [Utilisation dʼune couche de données sur votre site](implementation/implementation-basics/using-a-data-layer-on-your-site.md)
   + Avec Experience Platform Launch {#via-adobe-launch}
      + [Mise en œuvre dʼExperience Cloud sur les sites web avec Experience Platform Launch](https://docs.adobe.com/content/help/fr-FR/experience-cloud/implementing-in-websites-with-launch/index.html)
      + [Configuration de base de lʼextension Analytics de Launch](implementation/via-adobe-launch/basic-configuration-of-the-analytics-launch-extension.md)
      ...
      + [Configuration des paramètres généraux dans lʼextension Analytics de Launch](implementation/via-adobe-launch/configuring-general-settings-in-the-launch-analytics-extension.md)
      + [Configuration des variables globales dans lʼextension Analytics de Launch](implementation/via-adobe-launch/configuring-global-variables-in-the-launch-analytics-extension.md)
      + [Configuration des paramètres des cookies dans lʼextension Analytics de Launch](implementation/via-adobe-launch/configuring-cookie-settings-in-the-launch-analytics-extension.md)
      + [Utilisation du code personnalisé lors de la configuration de lʼextension Analytics de Launch](implementation/via-adobe-launch/using-custom-code-while-configuring-the-launch-analytics-extension.md)
      + [Utilisation dʼune couche de données pour définir le nom de page et dʼautres variables via Launch](implementation/via-adobe-launch/using-a-data-layer-to-set-page-name-and-other-variables-via-launch.md)
      + [Ajout de modules de mise en œuvre dans Launch](implementation/via-adobe-launch/adding-implementation-plug-ins-in-launch.md)
      + [Utilisation de doPlugins dans lʼextension Adobe Analytics](implementation/via-adobe-launch/use-doplugins-in-the-adobe-analytics-extension.md)
      ...
      + [Préparation dʼExperience Platform Launch pour la mise en œuvre dʼAnalytics](implementation/via-adobe-launch/preparing-adobe-launch-for-your-analytics-implementation.md)
      + [Création dʼéléments de données dans Experience Platform Launch pour la mise en œuvre d’Analytics](implementation/via-adobe-launch/creating-data-elements-in-launch-for-the-analytics-implementation.md)
      + [Création dʼune règle de page globale dans Experience Platform Launch](implementation/via-adobe-launch/creating-a-global-page-rule-in-launch.md)
      ...
      + [Publication des bibliothèques Experience Platform Launch dans les environnements dʼévaluation et de production](implementation/via-adobe-launch/publishing-launch-libraries-to-stage-and-production.md)
   + Utilisation de JavaScript {#using-javascript}
      ...
      + [Mise à jour dʼAppMeasurement sans lʼaide dʼExperience Platform Launch](implementation/using-javascript/updating-appmeasurement-when-not-using-adobe-launch.md)
   + Validation et dépannage {#validating-and-troubleshooting}
      + [Inspection des mises en œuvre avec Adobe Experience Cloud Debugger](implementation/validating-and-troubleshooting/inspecting-implementations-with-the-adobe-experience-cloud-debugger.md)
      + [Affichage des accès post-traités avec Experience Cloud Debugger](implementation/validating-and-troubleshooting/view-post-processed-hits-with-the-experience-cloud-debugger.md)
   + Pages SPA {#spa-pages}
...
+ Composants {#components}
   + Segmentation {#segmentation}
      ...
      + [Utilisation de segments dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-in-analysis-workspace.html)
      + [Utilisation de segments en tant que dimensions dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.html)
      + [Utilisation de segments pour limiter les données dans Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/applying-segments/using-segments-to-limit-data-in-analysis-workspace.html)
      ...
      + [Utilisation de lʼopérateur Est égal à un(e) dans la segmentation](components/segmentation/equals-any-of-operator-in-segmentation.md)
   + Mesures calculées {#calculated-metrics}
      ...
      + [Attribution IQ dans les mesures calculées](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/attribution-iq/attribution-iq-in-calculated-metrics.html)
   ...
   + Suites de rapports virtuelles {#virtual-report-suites}
      ...
      + [Début dʼune nouvelle visite sur nʼimporte quel événement dans les suites de rapports virtuelles](components/virtual-report-suites/start-a-new-visit-on-any-event-in-virtual-report-suites.md)
   + Activity Map {#activity-map}
      + [Aperçu dʼActivity Map](components/activity-map/activity-map-overview.md)
      + [Activation, débogage et personnalisation dʼAdobe Analytics Activity Map](components/activity-map/enabling-debugging-and-customizing-the-activity-map.md)
...
+ Exportation en cours {#exporting}
   + À partir de lʼinterface utilisateur {#from-the-ui}
      + [Exporter au format CSV à partir dʼAnalysis Workspace](exporting/from-the-ui/export-to-csv-from-analysis-workspace.md)
   ...
   + Report Builder {#report-builder}
      ...
      + [Utilisation de Report Builder pour apprendre à utiliser lʼAPI Adobe Analytics](exporting/report-builder/using-report-builder-to-learn-the-adobe-analytics-api.md)
+ Intégrations {#integrations}
   ...
   + Ad Cloud {#ad-cloud}
      ...
      + [Présentation de lʼintégration dʼAnalytics pour Advertising Cloud DSP](integrations/ad-cloud/introduction-to-the-analytics-for-advertising-cloud-dsp-integration.md)
      + [Création dʼune analyse de prélancement dʼune campagne](integrations/ad-cloud/create-a-pre-launch-campaign-analysis-with-adobe-analytics.md)
      ...
      + [Création dʼalertes Advertising Cloud avec Adobe Analytics](integrations/ad-cloud/create-advertising-cloud-alerts-with-adobe-analytics.md)
   ...
   + Analyses ad hoc {#ad-hoc-analytics}
      + [Utilisation de Project Converter pour déplacer des projets dʼAd Hoc Analysis vers Analytics Workspace](integrations/ad-hoc-analytics/using-the-project-converter-to-move-projects-from-ad-hoc-analysis-to-analytics-workspace.md)
   + Power BI {#power-bi}
      + [Connecteur Adobe Analytics dans Power BI](integrations/power-bi/adobe-analytics-connector-in-power-bi.md)
   + Magento {#magento}
      + [Modèle Magento dʼAnalysis Workspace](integrations/magento/magento-analysis-workspace-template.md)
+ Science des données {#data-science}
   + [Utilisation du machine learning et de lʼIA dʼAdobe Analytics pour les moments importants](data-science/using-machine-learning-and-ai-for-the-moments-that-matter.md)
...
+ Spécifique à la verticale {#vertical-specific}
   + Technologie de pointe {#high-tech}
      + [Super session du Summit 2019 - Technologie de pointe](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-high-tech.html)
   + Voyage et hébergement {#travel-and-hospitality}
      + [Super session du Summit 2019 - Voyage et hébergement](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-travel.html)
   + Vente au détail {#retail}
      ...
      + [Ajout de variables et dʼévénements de base de vente au détail aux règles Launch](vertical-specific/retail/adding-basic-retail-variables-and-events-to-launch-rules.md)
      + [Ajout dʼune règle Launch pour lʼévénement dʼachat](vertical-specific/retail/adding-a-launch-rule-for-the-purchase-event.md)
      + [Super session du Summit 2019 - Vente au détail](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-retail.html)
+ Media Analytics {#media-analytics}
   + Mesure de la voix ou de lʼaudio {#measuring-voice-or-audio}
      + [Utilisation du modèle de consommation audio dans Analysis Workspace](media-analytics/measuring-voice-or-audio/using-the-audio-consumption-template-in-analysis-workspace.md)
+ Analyse des applications mobiles {#mobile-app-analytics}
   + Implémentation {#implementation}
      + [Paramètres Administrateur pour les applications mobiles](mobile-app-analytics/implementation/admin-settings-for-mobile-apps.md)
   ...
   + Mesure des analyses mobiles {#measuring-mobile-analytics}
      + [Prise en main des analyses mobiles Adobe](mobile-app-analytics/measuring-mobile-analytics/getting-started-with-mobile-analytics.md)
      ...
      + [Comment augmenter les taux dʼengagement et de rétention](mobile-app-analytics/measuring-mobile-analytics/how-to-increase-engagement-and-retention-rates.md)
+ API {#apis}
   + [Utilisation dʼAnalysis Workspace pour créer des requêtes API 2.0](apis/using-analysis-workspace-to-build-api-2-requests.md)
   + [Utilisation de Report Builder pour apprendre à utiliser lʼAPI Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/using-report-builder-to-learn-the-adobe-analytics-api.html)
