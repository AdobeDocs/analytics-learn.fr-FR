...
+ Introduction à Analytics {#intro-to-analytics}
   ...
   + Concepts de base d’Analytics {#analytics-basics}
      ...
      + [Concepts de base de la mesure Visiteur](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/metrics/understanding-basic-visitor-metrics.html)
      + [Présentation des variables de trafic (props)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/dimensions/introduction-to-traffic-variables-props.html)
      + [Présentation des variables de conversion (eVars)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/dimensions/introduction-to-conversion-variables-evars.html)
      + [Présentation des événements de conversion](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/metrics/introduction-to-conversion-events.html)
   + Personnalisation de l’interface utilisateur {#customizing-the-ui}
      ...
      + [Configuration d’un projet Analysis Workspace en tant que page d’entrée](intro-to-analytics/customizing-the-ui/setting-an-analysis-workspace-project-as-your-landing-page.md)
...
+ Analysis Workspace {#analysis-workspace}
   + Principes de base d’Analysis Workspace {#analysis-workspace-basics}
      ...
      + [Création dʼun projet Workspace à partir de zéro](analysis-workspace/analysis-workspace-basics/building-a-workspace-project-from-scratch.md)
      ...
      + [Mesures fondamentales dans Adobe Analytics](analysis-workspace/analysis-workspace-basics/foundational-metrics-in-adobe-analytics.md)
   ...
   + Création de tableaux à structure libre {#building-freeform-tables}
      + [Cernez précisément vos données à lʼaide des tableaux à structure libre](analysis-workspace/building-freeform-tables/understand-your-data-freeform-tables.md)
   ...
   + Visualisations {#visualizations}
      ...
      + [Paramètres des sources de données de tableau et de visualisation](analysis-workspace/visualizations/table-and-visualization-data-source-settings.md)
...
+ Implémentation {#implementation}
   + Concepts de base de la mise en œuvre {#implementation-basics}
      ...
      + [Compréhension et création de suites de rapports](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/analytics-basics/understanding-and-creating-report-suites.html)
   ...
   + Avec Experience Platform Launch {#via-adobe-launch}
      + [Mise en œuvre d’Experience Cloud sur les sites web avec Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-cloud/implementing-in-websites-with-launch/index.html?lang=fr)
      + [Configuration de base de l’extension Analytics de Launch](implementation/via-adobe-launch/basic-configuration-of-the-analytics-launch-extension.md)
      ...
      + [Configuration des paramètres généraux dans l’extension Analytics de Launch](implementation/via-adobe-launch/configuring-general-settings-in-the-launch-analytics-extension.md)
      + [Configuration des variables globales dans l’extension Analytics de Launch](implementation/via-adobe-launch/configuring-global-variables-in-the-launch-analytics-extension.md)
      + [Configuration des paramètres des cookies dans l’extension Analytics de Launch](implementation/via-adobe-launch/configuring-cookie-settings-in-the-launch-analytics-extension.md)
      ...
      + [Préparation d’Experience Platform Launch pour la mise en œuvre d’Analytics](implementation/via-adobe-launch/preparing-adobe-launch-for-your-analytics-implementation.md)
   ...
   + Utilisation de JavaScript {#using-javascript}
      ...
      + [Mise à jour d’AppMeasurement sans l’aide d’Experience Platform Launch](implementation/using-javascript/updating-appmeasurement-when-not-using-adobe-launch.md)
...
+ Analyse des applications mobiles {#mobile-app-analytics}
   + Implémentation {#implementation}
      ...
      + [Mise en œuvre dans les applications iOS en Swift](https://experienceleague.adobe.com/docs/experience-cloud/implementing-in-mobile-ios-swift-apps-with-launch/index.html)
      + [Mise en œuvre dans les applications iOS en Objective-C](https://experienceleague.adobe.com/docs/experience-cloud/implementing-in-mobile-ios-objective-c-apps-with-launch/index.html)
      + [Mise en œuvre dans les applications Android](https://experienceleague.adobe.com/docs/experience-cloud/implementing-in-mobile-android-apps-with-launch/index.html)
