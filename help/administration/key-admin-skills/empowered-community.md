...
description: 'Apprenez à créer une communauté plus forte. Une communauté dotée de moyens est prise en charge par ses administrateurs Adobe Analytics, connaît les exigences de l’entreprise dans le cadre de leur mise en oeuvre et dispose des moyens d’utiliser en toute confiance l’analyse pour une prise de décision axée sur les données. '
feature: Admin Tools
...
Une communauté plus forte a quelques caractéristiques notables. Tout d’abord, il est pris en charge par ses administrateurs Adobe Analytics. Il connaît bien la manière dont les besoins de l’entreprise sont représentés dans leur mise en oeuvre. Enfin et surtout, il a les moyens d&#39;utiliser en toute confiance l&#39;analyse pour la prise de décision fondée sur les données. De nombreuses entreprises bénéficient de la structure fournie par un groupe d’utilisateurs Adobe Analytics interne ou une communauté plus formelle.

Vous pouvez créer une communauté autonome au sein de votre organisation. Procédez comme suit :
...
* Créez un processus d’intégration d’utilisateur :
   ...
   Quelles sont les exigences et les processus associés à l’accès Adobe Analytics pour votre entreprise ? Si vous n’avez pas encore les exigences et qu’un processus n’est pas en place pour l’intégration des nouveaux utilisateurs, la création de cette infrastructure prend en charge l’évolutivité.

* Implémentez une gestion et un accès utilisateur appropriés :

   L’accès des utilisateurs aux suites de rapports, aux mesures, aux dimensions, aux outils, aux rapports et aux composants est fondamental pour Adobe Analytics et constitue une partie essentielle de [processus de gestion des groupes d’utilisateurs](https://experienceleague.adobe.com/docs/analytics/admin/admin-console/home.html?lang=en). Un accès aux outils approprié permet aux utilisateurs de bénéficier de droits d’accès en libre-service dans Analysis Workspace et les Reports &amp; Analytics.

* Présentation de l’implémentation :

   En règle générale, les utilisateurs doivent posséder une connaissance de base des besoins de l’entreprise pris en charge par leur mise en oeuvre, qui sont généralement capturés via une [document sur les besoins](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/implementation-basics/creating-a-business-requirements-document.html?lang=en) (BRD) et [document de référence de conception de solution](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/implementation-basics/creating-and-maintaining-an-sdr.html?lang=en) (DTS). Ces exigences doivent inclure ce qui a été mis en oeuvre et définir les besoins de l’entreprise, les rapports, les eVars, les événements, etc., par catégorie.
...
* Définissez les personnes impliquées, les rôles et les responsabilités :
   ...
   * **Responsable :** Il est essentiel qu’un sponsor en charge de l’exécution soutienne le succès du groupe d’utilisateurs ou de la communauté interne de votre entreprise. Ce rôle est essentiel pour soutenir les jalons, la communication, assurer la hiérarchisation des priorités au sein de l’équipe élargie et la gestion du changement.

   * **Responsabilités liées aux fonctions :** Selon la taille et la structure de votre organisation, il peut être bénéfique d’impliquer des équipes comme le développement web, la personnalisation, les tests, etc.

   * **Utilisateurs d’outils :** Toute personne ayant le potentiel d’affecter les données alignées sur la mise en oeuvre Adobe Analytics de votre entreprise peut y être impliquée, quel que soit son titre ou son rôle.
...
* [Créer une charte de projet](assets/Adobe-Analytics-Empowered-Community-Project-Charter-Template.pptx) (téléchargement de modèle) :
...
* Créer un plan de communication - Un plan de communication solide sera la clé de l’engagement et du succès global de votre communauté. Voici quelques questions à prendre en compte lors de la création de votre plan :
   ...
   * Quels moyens de communication doivent être utilisés (par exemple, email, Slack, vidéo, réunions, etc.) avant ou après le lancement de la communauté ? Par exemple, enverrez-vous des emails via l’outil d’administration Adobe Analytics. Ou votre nouveau processus d’intégration des utilisateurs doit-il maintenant inclure la maintenance d’une liste de distribution interne d’emails qui peut être utilisée pour les newsletters, etc. ?
   * Qui enverra la communication ?
   * Lors de la? Clé pour tenir compte des communications avant le lancement de la communauté, ainsi que de celles qui doivent être fournies de manière continue après le lancement.

* Utilisez votre véhicule communautaire pour aller en direct ! Selon la pile technologique de votre entreprise, vous souhaiterez également choisir un outil ou un véhicule pour votre communauté. Il s’agit d’une personnalisation pour votre organisation, mais la plupart des utilisateurs trouvent souvent des Microsofts Teams pour bien fonctionner.

## 4. Maintenez votre communauté et garantissez son succès durable.

* Réserver l’heure : ajoutez des réunions communautaires aux calendriers pour bloquer l’heure à l’avance, les réunions récurrentes sont une excellente idée lorsque cela est possible et vous aideront à donner vie à votre plan de contenu. Pour vous aider à commencer, voici quelques idées de programme :

   * Si votre entreprise héberge des événements virtuels, quels enseignements et connaissances numériques peuvent être partagés plus largement ?
   ...
   * Comment votre entreprise tire-t-elle parti des fonctionnalités existantes pour améliorer et exploiter les informations sur les audiences ? Par exemple, votre entreprise utilise-t-elle la nouvelle intégration d’Adobe Analytics et de Marketo ? Quels enseignements et connaissances peuvent être partagés plus largement ?

* Définition des attentes - Continuez à tirer parti de votre charte de projet et de votre plan de communication pour établir des attentes par rapport à ce que votre communauté est et n’est pas. La cohérence est essentielle !
...
* Prise de décision fondée sur les données : une communauté dotée de moyens [changer votre activité](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-can-aa-do-for-me/how-adobe-analysis-workspace-can-change-your-business.html?lang=en), dans la mesure où Adobe Analytics permet la narration de données, prédit les résultats et prescrit les résultats, d’une manière accessible dans l’ensemble de l’organisation pour prendre en charge les renseignements sur les clients et la prise de décisions axée sur les données.

* Une expertise et une efficacité accrues : des corrélations directes peuvent être établies entre l’engagement de l’activation et le retour sur investissement marketing ! Une communauté plus forte réunit l&#39;expertise de tous, facilitant le partage d&#39;informations, de bonnes pratiques, de projets et de mises à jour de produits, encourageant la collaboration. Elle le fait tout en permettant l’autosuffisance et une optimisation accrue via Adobe Analytics. Il prend en charge le canal marketing, la page, la géolocalisation, l’audience, etc. Il prend également en charge les optimisations d’expérience, ce qui permet aux équipes de se concentrer sur les endroits où elles peuvent avoir le plus d’impact.

* Réalisation de la valeur : si votre entreprise a investi dans un outil aussi puissant qu’Adobe Analytics, il est dans l’intérêt de tous que vous réalisiez toute la valeur de son potentiel.
...
Si vous disposez d’un groupe d’utilisateurs Adobe Analytics interne ou d’une &quot;communauté&quot; plus formelle, ou que vous travaillez à en former un, nous serions ravis d’entendre votre histoire au sein de la [Adobe Experience League](https://experienceleaguecommunities.adobe.com/t5/adobe-analytics-discussions/bd-p/adobe-analytics-discussions)!
